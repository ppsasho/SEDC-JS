let getDataBtn = document.getElementById("dataBtn");
let jokesContainerElement = document.getElementById("myMain");

function Joke(type, setup, punchline) {
  (this.type = type), (this.question = setup), (this.answer = punchline);
