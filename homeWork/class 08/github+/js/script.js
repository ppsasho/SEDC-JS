...
function specificExercise(inputObject, num){
  Number(num.value);
  if (num.value > 10 || num.value < 0 || isNaN(num.value)) {
...
submitButton.addEventListener("click", function () {
    ...
    Number(numOfExcercises.value);

    if (numOfExcercises.value > 10 || numOfExcercises.value < 0 || isNaN(numOfExcercises.value)) {
      alert("too much excercises, give the students some time to learn!!");
    }
...
specificButton.addEventListener("click", function() {
  specificExercise(vezbi, numOfExcercises);
})

funnyButton.addEventListener("click", function() {
body.style.backgroundColor = "white";
body.style.color = "black";
funnyButton2.style.visibility = "visible";
})

funnyButton2.addEventListener("click", function() {
body.style.backgroundColor = "black";
body.style.color = "white";
funnyButton.value = "Whaaaat?";
})
